...
namespace BSynchro.DAL.Migrations
{
    ...
    [Migration("20220723095459_Remove-Currency_Col")]
    partial class RemoveCurrency_Col
    {
            ...
            modelBuilder.Entity("BSynchro.DAL.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("84b1b509-cdab-4e99-80f8-a44cc339cf41"),
                            BirthDate = new DateTime(1995, 3, 14, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            City = "Kafrdenis",
                            CreatedBy = "Seed_Function",
                            CreatedDate = new DateTime(2022, 7, 23, 12, 54, 59, 509, DateTimeKind.Local).AddTicks(2970),
                        ...
                        new
                        {
                            Id = new Guid("b1c8eec1-9358-470f-84f3-4791cb531f7f"),
                            BirthDate = new DateTime(1991, 6, 14, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            City = "Al Rafed",
                            CreatedBy = "Seed_Function",
                            CreatedDate = new DateTime(2022, 7, 23, 12, 54, 59, 509, DateTimeKind.Local).AddTicks(3018),
                        ...
                        new
                        {
                            Id = new Guid("924e4753-e1d3-496c-b20a-795dabfe10a4"),
                            BirthDate = new DateTime(2000, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            City = "Bierut",
                            CreatedBy = "Seed_Function",
                            CreatedDate = new DateTime(2022, 7, 23, 12, 54, 59, 509, DateTimeKind.Local).AddTicks(3025),
